<#
.SYNOPSIS
  Utility script 001 for lightweight workstation automation.
.DESCRIPTION
...
function GetDiskHealth001 {
    ...
    $record = [PSCustomObject]@{
        ScriptId   = '001'
        ScriptName = 'GetDiskHealth001'
        RanAtUtc   = $now.ToUniversalTime().ToString('o')
        HostName   = $env:COMPUTERNAME
        UserName   = $env:USERNAME
    }

    $logFile = Join-Path -Path $Destination -ChildPath 'GetDiskHealth001.log'
...
$result = GetDiskHealth001 -Destination $OutputPath
