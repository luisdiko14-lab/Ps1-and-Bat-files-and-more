<#
.SYNOPSIS
  Utility script 177 for lightweight workstation automation.
.DESCRIPTION
...
function SetHashReport177 {
    ...
    $record = [PSCustomObject]@{
        ScriptId   = '177'
        ScriptName = 'SetHashReport177'
        RanAtUtc   = $now.ToUniversalTime().ToString('o')
        HostName   = $env:COMPUTERNAME
        UserName   = $env:USERNAME
    }

    $logFile = Join-Path -Path $Destination -ChildPath 'SetHashReport177.log'
...
$result = SetHashReport177 -Destination $OutputPath
