<#
.SYNOPSIS
  Utility script 002 for lightweight workstation automation.
.DESCRIPTION
...
function SetDiskHealth002 {
    ...
    $record = [PSCustomObject]@{
        ScriptId   = '002'
        ScriptName = 'SetDiskHealth002'
        RanAtUtc   = $now.ToUniversalTime().ToString('o')
        HostName   = $env:COMPUTERNAME
        UserName   = $env:USERNAME
    }

    $logFile = Join-Path -Path $Destination -ChildPath 'SetDiskHealth002.log'
...
$result = SetDiskHealth002 -Destination $OutputPath
